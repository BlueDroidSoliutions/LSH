	...
	<div class="container full-screen-height">
		...
		<div id="page-wrap">
			<div class="wrapper ">
				...
				<div class="models-online private-only">
					<p>
						Models<br>online:
					</p>
					<p class="big">258</p>
						...
						<div class="left-container">
							<div class="main-video-block">
								...
								<div class="video-tabs">
									...
									<div class="video-tab"><a href="javascript:;">PRIVATE</a></div>
									<div class="video-tab"><a href="javascript:;">Group chat</a></div>
									<div class="video-tab tip-btn">
										<a href="javascript:;">
											TIP ME 
											<span><svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.88 24.88"><defs><style>.cls-1{fill:#fff;}.cls-2{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:1.53px;}</style></defs><title>token</title><ellipse class="cls-1" cx="12.42" cy="7.56" rx="5.68" ry="2.05"/><path class="cls-1" d="M7.3,10.47v2.6a12.19,12.19,0,0,0,11.35,0V10.41S13.95,13.66,7.3,10.47Z" transform="translate(-0.56 -0.06)"/><path class="cls-1" d="M7.3,15.31v2.6a12.19,12.19,0,0,0,11.35,0V15.25S13.95,18.5,7.3,15.31Z" transform="translate(-0.56 -0.06)"/><circle class="cls-2" cx="12.44" cy="12.44" r="11.68"/></svg>
											</span>
										</a>
									</div>
								</div>
							...
							<div class="bottom">
								<div class="main-info">
									<ul class="main-info-list">
										<li class="user-name">
											<img src="${location}/assets/img/content/profile-s.png" alt="user_image">
											<p>
								...
								<div class="chat-box-middle">
									...
									<div class="fakeScroll">
										<div id="tab-2" class="tab-content">
											<ul>
												<li>
													<div class="tab-single"><img src="${location}/assets/img/content/profile-s.png" alt=""></div>
							...
							<div class="flexslider">
								<div class="custom-navigation custom-navigation-left">
									<a href="#" class="flex-prev">
										<img src="${location}/assets/img/arrow_left.png" alt="" />
									</a>
								</div>
							  <ul class="slides">
							    <li>
							      <img src="${location}/assets/img/content/slider-small.png" />
							    </li>
							    <li>
							      <img src="${location}/assets/img/content/slider-small.png" />
							    </li>
								...
								<div class="custom-navigation custom-navigation-right">
									<a href="#" class="flex-next">
										<img src="${location}/assets/img/arrow_right.png" alt="" />
									</a>
								</div>
							</div>
						</div>
