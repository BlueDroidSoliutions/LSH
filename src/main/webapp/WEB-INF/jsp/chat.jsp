...
console.log('&&&&&&*******************************************************************2');
            function connect2() {
                console.log('&&&&&&*******************************************************************3');
                socket7 = new SockJS('/www.livesexhouse.com/chat');
                stompClient7 = Stomp.over(socket7);
                stompClient7.connect('', '', function (frame) {

                    // pretplacujemo se na kanal sa aktivnim userima i zovemo ovo kada ima apdejta
                    stompClient7.subscribe('/topic/activeG', function (activeMembersOnline) {
                        showActiveOnline(activeMembersOnline);
                         console.log('IMAAAAAAAAAAAAA11');
                    });

                    // pretplacujemo se na kanal sa aktivnim userima i zovemo ovo kada ima apdejta
                    stompClient7.subscribe('/topic/activeGP', function (activeMembersPrivate) {
                        showActivePrivate(activeMembersPrivate);
                        console.log('IMAAAAAAAAAAAAA22');
                    });
                });
            }
