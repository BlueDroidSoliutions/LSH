		...
		<div id="page-wrap">
                    <div class="content" style="padding-bottom: 50px;">
                            <div class="wrapper" style="color:white;">
                                ...
                                <h1 style="font-size:50px; text-align: center;">Terms and Conditions</h1>
...
PLEASE CAREFULLY READ THESE TERMS AND CONDITIONS. YOU ARE BOUND BY THEM. By visiting this website or by using any service, product, software or other aspect of this website (which together are referred to herein as the "Service"), you are agreeing to be bound by all provisions stated in these Terms and Conditions and all provisions stated in our Privacy Policy. By using the Service, you are entering into a binding agreement between you and livesexhouse.com (which is referred to in these Terms and Conditions as "we," "us," or "our"). You are referred to below in these Terms and Conditions as "You," "Your," or "Member." Additionally, You may be subject to additional terms and conditions that may apply when You use any third-party services or software. If You do not agree to be bound by these Terms and Conditions, then You must leave our website and not use the Service.
</br>
You should periodically review the most up-to-date versions of these Terms and Conditions and our Privacy Policy. We may, in our sole discretion, amend or change these Terms and Conditions and our Privacy Policy at any time. You agree to be bound by any such amendments or changes.
</br>
In order to enter the site you must state that you are 18 by clicking a button that states that you are 18 and permited to visit this website.
...
There is required age In order to visit our website or become a Member of our website, You must be 18 YEARS OLD or over the limit of 18 and the age of majority in each and every jurisdiction in which You view our website. If You are not at least 18 years old and the age of majority in Your jurisdiction, then You must immediately leave our website.
...
When visiting our website or by becoming a Member of our website, You acknowledge and certify that:
</br>
a. You will not provide or permit access or use of Your Account or the Service to any minor, in any case and You will not engage or take any action while visiting our website or using the Service which in any way promotes inappropriate sexual activity involving minors.
</br>
b. The Service may not be accessed or used where prohibited by local law or other law. So you must leave this website immediately if this happens. Your use of the Service must be in compliance with all applicable laws, rules, regulations, and ordinances.
</br>
c. You are at least 18 years old and the age of majority in each and every jurisdiction in which You view our website.
</br>
d. In visiting our website or using the Service, You may encounter Content that may be considered sexually explicit, offensive, indecent or objectionable, which Content may not be specifically identified as such. YOU FULLY ASSUME ALL RISK OF LOSS AND HARM ARISING OUT OF YOUR USE OF THE SERVICE.
</br>
e. You are responsible for maintaining the confidentiality of and restricting access to Your Account and password. You agree to accept sole responsibility for all activities that occur under Your Account or password. You agree to contact our customer service department immediately of any breach of security or unauthorized use of Your Account or any violation of these Terms and Conditions by others of which You are aware. Do not share your account info with others.
</br>
f. Since our website may contain links or ads to third-party websites or services, You acknowledge and agree that we have no control over, do not endorse, and are not responsible in any way for any actions taken by or damages sustained by You relating to such third-party websites or services.
</br>
...
d. Intentionally or unintentionally violate any applicable local, state, national, international or foreign law, including but not limited to any rules or regulations having the force of law;
</br>
e. Post or submit any unlawful, harmful, threatening, abusive, harassing, defamatory, obscene, hateful, or racially or ethnically objectionable Content;
</br>
f. Harass, threaten, embarrass, or cause distress, unwanted attention or discomfort upon another Member or other user of our website or any other person or entity;
</br>
g. Post, transmit, promote, link, or facilitate the distribution of Content that may generally be considered obscene, including but not limited to bestiality, urination/defecation, fisting, incest, extreme sadomasochism or bondage presented in a sexual context, or any presentation of minors engaged in intimate physical contact or sexual situations, acted or depicted;
</br>
h. Disrupt the normal flow of dialogue in a chat room or on a message board or otherwise act in a manner that negatively affects other Members, users, individuals or entities;
</br>
i. Impersonate a minor; impersonate any other person or entity (including but not limited to one of our representatives, an ICP, forum leader, guide or host); or communicate under a false name or a name that You are not entitled or authorized to use;
</br>
j. Post or submit (or cause to be posted or submitted) a chain letter or pyramid scheme;
</br>
k. Post or submit (or cause to be posted or submitted) any unsolicited advertising, promotional materials, or other forms of solicitation to other Members, individuals or entities, or collect or harvest screen names of other Members, without permission;
</br>
l. Post or submit (or cause to be posted or submitted) any communication or solicitation designed or intended to obtain a password of an account or private or financial information from any Member;
</br>
m. Violate any operating rules, policies or guidelines of any other interactive service or website in any way; or
</br>
n. Spread or distribute any spam, viruses, bugs of any type whatsoever, junk email, or mass email solicitations
