...
<body>
    ...
    <p  style="color: white">User Name: ${userName}</p>
     ...
     <script>
            var privateU = '<c:out value="${privateU}"/>';
        </script>
    
    
        <p>private user: ${privateU}</p>
...
//
      function sendMessageTo(sentTo) {
        var chatInput = '#input-chat-' + privateU;
