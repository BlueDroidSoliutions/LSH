...
@NamedQueries({
    ...
    , @NamedQuery(name = "Online.findById", query = "SELECT o FROM Online o WHERE o.id = :id")
        ...
        , @NamedQuery(name = "Online.findMemberOnline", query = "SELECT count(*) FROM Online o WHERE o.status = 5")
        , @NamedQuery(name = "Online.findAllOnline", query = "SELECT o.id FROM Online o WHERE o.status = 2 OR o.status = 3 OR o.status = 4")
        , @NamedQuery(name = "Online.findAllOnline23", query = "SELECT o.id FROM Online o WHERE o.status = 2 OR o.status = 3 ")
