...
public class VideoRoom implements Serializable {
    ...
    public VideoRoom(Integer id) {
        this.id = id;
    }

    public VideoRoom(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VideoRoom)) {
            return false;
        }
        VideoRoom other = (VideoRoom) object;
    ...
    public String toString() {
        return "com.livesexhouse.model.VideoRoom[ id=" + id + " ]";
    }
